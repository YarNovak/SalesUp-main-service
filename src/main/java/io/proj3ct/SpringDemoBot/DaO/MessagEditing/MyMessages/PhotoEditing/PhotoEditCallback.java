...
@Component
public class PhotoEditCallback implements CallbackHandler {
    ...
    @Autowired
    private LinkDecider linkDecider;
    ...
    public boolean support(String callbackData) {
        return callbackData.startsWith("PHOTO:");
    }
        ...
        // System.out.println("99999999999999999999999999999999999999999999999999999999999999");
            ...
            if(b.get().getPhoto() != null){
              ...
              //  sendPhoto.setPhoto(inputFile);
                //sendPhoto.setCaption("You have this one");
